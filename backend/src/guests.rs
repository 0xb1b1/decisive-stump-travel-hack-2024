...
// Credit for Fairing implementation: https://github.com/rwf2/Rocket/issues/2142#issuecomment-1086660848
#[rocket::async_trait]
...
async fn rocket() -> _ {
    ...
    let bucket = ds_travel_hack_2024::connections::s3::get_bucket(Some("images-tmp"))
        .await
        .unwrap();
